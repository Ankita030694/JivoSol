        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-12 mb-12">
            ...
            <div className="md:col-span-2 pr-4">
              <h3 className="text-2xl mb-4">Get the latest inspiration & insights</h3>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><Link href="#">Brand Identity & Design</Link></li>
                <li><Link href="#">Web Development & SEO</Link></li>
                <li><Link href="#">Video & Animation</Link></li>
                <li><Link href="#">Content Creation & Production</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <p className="mb-4">Space business park, Sector 66, Gurugram, Haryana 122102</p>
              <a href="mailto:info@jivosolutions.com" className="text-[#7AA792] block mb-2">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center pt-8 border-t border-gray-800">
            <div className="mb-4 md:mb-0">
              <p>© 2023-2024 <Link href="#" className="underline">Dtech</Link>. All Rights Reserved.</p>
            </div>
            <div className="flex items-center gap-4">
              <span className="text-gray-400">Follow Us</span>
              <Link href="#" className="hover:text-[#7AA792]">Facebook</Link>
              <span className="text-gray-400">•</span>
              <Link href="#" className="hover:text-[#7AA792]">Instagram</Link>
              <span className="text-gray-400">•</span>
              <Link href="#" className="hover:text-[#7AA792]">YouTube</Link>
            </div>
          </div>
        </div>
      </footer>
