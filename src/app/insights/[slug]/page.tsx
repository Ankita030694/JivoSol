    ...
    <div className="bg-gray-50">
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="max-w-4xl mx-auto bg-white shadow-sm rounded-xl overflow-hidden">
          ...
          <div className="flex items-center p-6 border-b border-gray-100">
            ...
            <div className="ml-4">
              ...
              <p className="text-sm text-gray-500">{blog.date} • {blog.subtitle}</p>
            </div>
          ...
          {/* <div className="px-6 md:px-10 pb-6 flex flex-wrap gap-2">
            <span className="px-3 py-1 bg-gray-100 text-gray-800 text-sm rounded-full">Digital Marketing</span>
            <span className="px-3 py-1 bg-gray-100 text-gray-800 text-sm rounded-full">SEO</span>
            <span className="px-3 py-1 bg-gray-100 text-gray-800 text-sm rounded-full">Content Strategy</span>
          </div> */}
          ...
          <div className="px-6 md:px-10 py-8 bg-gradient-to-r from-[#2B5741]/10 to-[#2B5741]/5 border-t border-gray-100">
            <div className="flex flex-col md:flex-row items-center justify-between">
              ...
              <Link href="/contact" className="px-6 py-2 bg-[#2B5741] text-white rounded-full hover:bg-[#1e3d2d] transition">
                Contact Us
              </Link>
            </div>
          </div>
        ...
        <div className="flex justify-center mt-12">
          <Link href="/insights" className="px-6 py-3 bg-gray-100 text-gray-700 rounded-full hover:bg-gray-200 transition flex items-center gap-2">
