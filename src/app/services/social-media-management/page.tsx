...
export default function InsightsPage() {
  ...
  return (
    <div>
      ...
      <div className="py-8 sm:py-8 mx-auto text-center px-4 xxl:px-8">
        <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4 sm:mb-6 text-black">Be Seen. Be Trusted. Be Talked About.</h2>
        ...
        <p className="mb-4 sm:mb-6 text-black text-sm sm:text-base">We manage and grow your brand across all leading platforms:</p>
        ...
        <div className="flex justify-center gap-2 sm:gap-4 flex-wrap">
          {["Instagram", "Facebook", "YouTube", "LinkedIn", "Threads", "Twitter", "Pinterest"].map(
            (platform) => (
              <button
                key={platform}
                className="px-3 sm:px-6 py-1 sm:py-2 rounded-full border border-emerald-700 text-xs sm:text-sm"
              >
      ...
      <div className="py-12 sm:py-8 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4 xxl:px-8">
          <h2 className="text-2xl sm:text-3xl font-bold mb-6 sm:mb-8 text-center text-black">Why Social Media matters for your business</h2>
          <p className="mb-6 sm:mb-8 text-black text-center max-w-4xl mx-auto text-sm sm:text-base">
            Social media isn't just about looking good, it's a tool for real business growth. We use it to help brands:
          </p>
          
          <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 max-w-4xl mx-auto">
            <div className="text-center">
              <div className="bg-emerald-700 text-white p-3 sm:p-4 rounded-lg mb-3 sm:mb-4">
                <svg className="w-6 h-6 sm:w-8 sm:h-8 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                </svg>
              </div>
              <p className="text-black font-medium text-xs sm:text-sm">Build awareness in competitive markets</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-black font-medium text-xs sm:text-sm">Increase engagement with the right audience</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-black font-medium text-xs sm:text-sm">Turn followers into paying customers</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-black font-medium text-xs sm:text-sm">Show up consistently and professionally</p>
            </div>
          </div>
          
          <p className="mt-6 sm:mt-8 text-black text-center max-w-4xl mx-auto text-sm sm:text-base">
      ...
      <div className="py-12 sm:py-8">
        <div className="max-w-6xl mx-auto px-4 xxl:px-8 text-center">
          <h2 className="text-2xl sm:text-3xl font-bold mb-4 sm:mb-6 text-black">Our social content showcase</h2>
          ...
          <div className="hidden sm:block relative w-full max-w-[800px] mx-auto mb-6 sm:mb-8">
            <div className="flex items-center justify-center gap-2 sm:gap-4 relative">
              ...
              <div 
                className={`w-[180px] sm:w-[180px] md:w-[200px] h-[316px] sm:h-[316px] md:h-[352px] rounded-lg overflow-hidden opacity-40 blur-sm transform scale-95 transition-all duration-500 ease-in-out ${
              ...
              {/* Main Video */}
              <div 
                className={`w-[220px] sm:w-[220px] md:w-[260px] h-[387px] sm:h-[387px] md:h-[460px] relative z-10 transition-all duration-500 ease-in-out transform ${
              ...
              >
                ...
                <button
                  onClick={() => setIsMuted(!isMuted)}
                  className="absolute bottom-2 sm:bottom-4 right-2 sm:right-4 bg-black bg-opacity-50 text-white p-1.5 sm:p-2 rounded-full z-20 hover:bg-opacity-70 transition-all duration-300"
                >
                  {isMuted ? (
            ...
            <button 
              onClick={prevVideo}
              className="absolute left-2 sm:left-4 top-1/2 transform -translate-y-1/2 bg-black bg-opacity-50 text-white p-1.5 sm:p-2 rounded-full z-20 hover:bg-opacity-70 transition-all duration-300"
            >
              <svg className="h-3 w-3 sm:h-4 sm:w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <button 
              onClick={nextVideo}
              className="absolute right-2 sm:right-4 top-1/2 transform -translate-y-1/2 bg-black bg-opacity-50 text-white p-1.5 sm:p-2 rounded-full z-20 hover:bg-opacity-70 transition-all duration-300"
            >
              <svg className="h-3 w-3 sm:h-4 sm:w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <div className="py-12 sm:py-8 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4 xxl:px-8">
          <h2 className="text-2xl sm:text-3xl font-bold mb-6 sm:mb-8 text-center text-black">Platforms JIVO specializes in</h2>
          <p className="mb-8 sm:mb-12 text-black text-center max-w-4xl mx-auto text-sm sm:text-base">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            ...
            <div className="bg-white p-4 sm:p-6 rounded-lg shadow-md h-full flex flex-col">
              <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
                <div className="w-8 h-8 sm:w-10 sm:h-10 flex items-center justify-center rounded-lg" style={{ backgroundColor: '#1877F2' }}>
                ...
                <h3 className="text-lg sm:text-xl font-bold text-emerald-700">Facebook Management</h3>
              </div>
              <p className="text-black text-xs sm:text-sm leading-relaxed flex-grow">
            ...
            <div className="bg-white p-4 sm:p-6 rounded-lg shadow-md h-full flex flex-col">
              <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
                <div className="w-8 h-8 sm:w-10 sm:h-10 flex items-center justify-center rounded-lg" style={{ background: 'linear-gradient(45deg, #405DE6, #5851DB, #833AB4, #C13584, #E1306C, #FD1D1D, #F56040, #F77737, #FCAF45, #FFDC80)' }}>
                  <svg className="w-5 h-5 sm:w-6 sm:h-6" fill="white" viewBox="0 0 24 24">
                ...
                <h3 className="text-lg sm:text-xl font-bold text-emerald-700">Instagram Management</h3>
              </div>
              <p className="text-black text-xs sm:text-sm leading-relaxed flex-grow">
            ...
            <div className="bg-white p-4 sm:p-6 rounded-lg shadow-md h-full flex flex-col">
              <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
                <div className="w-8 h-8 sm:w-10 sm:h-10 flex items-center justify-center rounded-lg" style={{ backgroundColor: '#0A66C2' }}>
                  <svg className="w-5 h-5 sm:w-6 sm:h-6" fill="white" viewBox="0 0 24 24">
                    <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
                  </svg>
                </div>
                <h3 className="text-lg sm:text-xl font-bold text-emerald-700">LinkedIn Management</h3>
              </div>
              <p className="text-black text-xs sm:text-sm leading-relaxed flex-grow">
            ...
            <div className="bg-white p-4 sm:p-6 rounded-lg shadow-md h-full flex flex-col">
              <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
                <div className="w-8 h-8 sm:w-10 sm:h-10 flex items-center justify-center rounded-lg" style={{ backgroundColor: '#FF0000' }}>
                  <svg className="w-5 h-5 sm:w-6 sm:h-6" fill="white" viewBox="0 0 24 24">
                    <path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/>
                  </svg>
                </div>
                <h3 className="text-lg sm:text-xl font-bold text-emerald-700">YouTube Management</h3>
              </div>
              <p className="text-black text-xs sm:text-sm leading-relaxed flex-grow">
            ...
            <div className="bg-white p-4 sm:p-6 rounded-lg shadow-md h-full flex flex-col">
              <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
                <div className="w-8 h-8 sm:w-10 sm:h-10 flex items-center justify-center rounded-lg" style={{ backgroundColor: '#000000' }}>
                  <svg className="w-5 h-5 sm:w-6 sm:h-6" fill="white" viewBox="0 0 24 24">
                    <path d="M18.901 1.153h3.68l-8.04 9.19L24 22.846h-7.406l-5.8-7.584-6.638 7.584H.474l8.6-9.83L0 1.154h7.594l5.243 6.932ZM17.61 20.644h2.039L6.486 3.24H4.298Z"/>
                  </svg>
                </div>
                <h3 className="text-lg sm:text-xl font-bold text-emerald-700">Twitter/X Management</h3>
              </div>
              <p className="text-black text-xs sm:text-sm leading-relaxed flex-grow">
            ...
            <div className="bg-white p-4 sm:p-6 rounded-lg shadow-md h-full flex flex-col">
              <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
                <div className="w-8 h-8 sm:w-10 sm:h-10 flex items-center justify-center rounded-lg" style={{ backgroundColor: '#E60023' }}>
                  <svg className="w-5 h-5 sm:w-6 sm:h-6" fill="white" viewBox="0 0 24 24">
                ...
                <h3 className="text-lg sm:text-xl font-bold text-emerald-700">Pinterest Management</h3>
              </div>
              <p className="text-black text-xs sm:text-sm leading-relaxed flex-grow">
      ...
      <div className="bg-[#0A5C35] text-white py-12 sm:py-8 px-4 xxl:px-8">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 mt-8 sm:mt-12">
            <div className="bg-white/10 p-4 sm:p-6 rounded-lg">
              <h3 className="text-lg sm:text-xl font-bold mb-3 sm:mb-4">Customized for your Brand</h3>
              <p className="text-xs sm:text-sm leading-relaxed">Your business is unique and your social media should be too. At JIVO, we craft tailored content plans that reflect your goals, niche, and audience. No recycled ideas, only original strategies designed to work for your brand.</p>
            </div>
            
            <div className="bg-white/10 p-4 sm:p-6 rounded-lg">
              <h3 className="text-lg sm:text-xl font-bold mb-3 sm:mb-4">Deep Platform Expertise</h3>
              <p className="text-xs sm:text-sm leading-relaxed">From Reels to LinkedIn carousels, we know what works where and why. Our team brings proven experience in creating content that feels native, drives engagement, and performs across all major platforms.</p>
            </div>
            
            <div className="bg-white/10 p-4 sm:p-6 rounded-lg">
              <h3 className="text-lg sm:text-xl font-bold mb-3 sm:mb-4">Strategic Approach</h3>
              <p className="text-xs sm:text-sm leading-relaxed">We don't post for the sake of posting. Every caption, story, and design starts with a data-backed strategy, from audience insights to market trends, so your feed fuels real business outcomes.</p>
            </div>
            
            <div className="bg-white/10 p-4 sm:p-6 rounded-lg">
              <h3 className="text-lg sm:text-xl font-bold mb-3 sm:mb-4">One Point of Contact</h3>
              <p className="text-xs sm:text-sm leading-relaxed">You'll work directly with a dedicated Account Manager who understands your brand inside-out and keeps your social media running seamlessly with clarity, collaboration, and care.</p>
            </div>
            
            <div className="bg-white/10 p-4 sm:p-6 rounded-lg">
              <h3 className="text-lg sm:text-xl font-bold mb-3 sm:mb-4">Sharp Trendspotting</h3>
              <p className="text-xs sm:text-sm leading-relaxed">We stay ahead of the curve with trend tracking, format experiments, and real-time platform updates helping you show up where it matters, when it matters.</p>
            </div>
            
            <div className="bg-white/10 p-4 sm:p-6 rounded-lg">
              <h3 className="text-lg sm:text-xl font-bold mb-3 sm:mb-4">Clear Reporting</h3>
              <p className="text-xs sm:text-sm leading-relaxed">Every month, we share performance reports that are easy to understand and packed with insight. Know what's working, why it's working and what's next.</p>
            </div>
          </div>
        </div>
      </div>
       ...
       <div className="py-12 sm:py-8">
        <div className="max-w-6xl mx-auto px-4 xxl:px-8">
          <h2 className="text-2xl sm:text-3xl font-bold mb-6 sm:mb-8 text-center text-black">Our Social Media Management process</h2>
          <p className="mb-8 sm:mb-12 text-black text-center max-w-4xl mx-auto text-sm sm:text-base">
          ...
          <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            <div className="text-center">
              <div className="bg-emerald-700 text-white w-12 h-12 sm:w-16 sm:h-16 rounded-full flex items-center justify-center text-lg sm:text-2xl font-bold mx-auto mb-3 sm:mb-4">1</div>
              <h3 className="text-sm sm:text-lg font-bold mb-2 text-black">Strategy Development</h3>
              <p className="text-black text-xs sm:text-sm">We analyze your brand, audience, and goals to create a tailored social media strategy.</p>
            </div>
            
            <div className="text-center">
              <div className="bg-emerald-700 text-white w-12 h-12 sm:w-16 sm:h-16 rounded-full flex items-center justify-center text-lg sm:text-2xl font-bold mx-auto mb-3 sm:mb-4">2</div>
              <h3 className="text-sm sm:text-lg font-bold mb-2 text-black">Content Creation</h3>
              <p className="text-black text-xs sm:text-sm">Our team creates high-quality visuals, videos, and copy that align with your brand voice.</p>
            </div>
            
            <div className="text-center">
              <div className="bg-emerald-700 text-white w-12 h-12 sm:w-16 sm:h-16 rounded-full flex items-center justify-center text-lg sm:text-2xl font-bold mx-auto mb-3 sm:mb-4">3</div>
              <h3 className="text-sm sm:text-lg font-bold mb-2 text-black">Publishing & Engagement</h3>
              <p className="text-black text-xs sm:text-sm">We publish content at optimal times and actively engage with your audience.</p>
            </div>
            
            <div className="text-center">
              <div className="bg-emerald-700 text-white w-12 h-12 sm:w-16 sm:h-16 rounded-full flex items-center justify-center text-lg sm:text-2xl font-bold mx-auto mb-3 sm:mb-4">4</div>
              <h3 className="text-sm sm:text-lg font-bold mb-2 text-black">Analytics & Optimization</h3>
              <p className="text-black text-xs sm:text-sm">We track performance and continuously optimize your strategy for better results.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <section className="py-12 sm:py-8 bg-gradient-to-b from-[#0a5c35]/5 to-white relative">
