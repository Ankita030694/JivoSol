...
export default function InsightsPage() {
  ...
  return (
    <div>
      ...
      <div className="container mx-auto px-4 xxl:px-8 py-8 sm:py-12 md:py-16">
        <div className="text-center mb-8 sm:mb-12">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4 sm:mb-6 text-black">Powerful visuals that bring your brand to life</h2>
          ...
          <p className="text-sm sm:text-base md:text-lg text-gray-700 mb-8 sm:mb-12 max-w-4xl mx-auto">
        ...
        <div className="text-center mb-8 sm:mb-12">
          <h3 className="text-lg sm:text-xl md:text-2xl font-bold mb-4 sm:mb-6 text-black">High-quality visuals are one of the most effective tools for brand building. With the right content, you can:</h3>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8 max-w-6xl mx-auto">
          <div className="bg-white p-4 sm:p-6 rounded-lg shadow-lg border border-gray-100">
            <div className="w-10 h-10 sm:w-12 sm:h-12 bg-[#0a5c35] rounded-lg flex items-center justify-center mb-3 sm:mb-4 mx-auto">
            ...
            <h4 className="text-sm sm:text-base md:text-lg font-semibold text-center mb-2 text-black">Create a Professional, Polished Brand Image</h4>
          </div>
          ...
          <div className="bg-white p-4 sm:p-6 rounded-lg shadow-lg border border-gray-100">
            ...
            <h4 className="text-sm sm:text-base md:text-lg font-semibold text-center mb-2 text-black">Communicate Your Product or Service Value Instantly</h4>
          </div>
          ...
          <div className="bg-white p-4 sm:p-6 rounded-lg shadow-lg border border-gray-100">
            ...
            <h4 className="text-sm sm:text-base md:text-lg font-semibold text-center mb-2 text-black">Build Trust and Credibility With Your Audience</h4>
          </div>
          ...
          <div className="bg-white p-4 sm:p-6 rounded-lg shadow-lg border border-gray-100">
            ...
            <h4 className="text-sm sm:text-base md:text-lg font-semibold text-center mb-2 text-black">Stand Out on Platforms Like Instagram, LinkedIn, and Your Website</h4>
          </div>
          ...
          <div className="bg-white p-4 sm:p-6 rounded-lg shadow-lg border border-gray-100">
            ...
            <h4 className="text-sm sm:text-base md:text-lg font-semibold text-center mb-2 text-black">Boost Ad Performance With Better-Quality Creative</h4>
          </div>
          ...
          <div className="bg-white p-4 sm:p-6 rounded-lg shadow-lg border border-gray-100">
            ...
            <h4 className="text-sm sm:text-base md:text-lg font-semibold text-center mb-2 text-black">Tell Your Story Through Visuals That Feel Real and Relatable</h4>
          </div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 xxl:px-8 py-8 sm:py-12 md:py-16">
        <div className="text-center mb-8 sm:mb-12">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-3 sm:mb-4 text-black">Visual Content Creation</h2>
          <p className="text-black text-sm sm:text-base">
            We handle full production across industries, from concept to shoot to final delivery.
          </p>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 mb-8 sm:mb-12 px-4 sm:px-12 md:px-24 lg:px-48">
          <div className="space-y-3 sm:space-y-4">
            <div className="flex items-center gap-2 sm:gap-3">
              <div className="min-w-5 w-5 h-5 sm:min-w-6 sm:w-6 sm:h-6 flex items-center justify-center bg-[#0a5c35] rounded-sm">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="white" className="w-3 h-3 sm:w-4 sm:h-4">
                  <path fillRule="evenodd" d="M19.916 4.626a.75.75 0 01.208 1.04l-9 13.5a.75.75 0 01-1.154.114l-6-6a.75.75 0 011.06-1.06l5.353 5.353 8.493-12.739a.75.75 0 011.04-.208z" clipRule="evenodd" />
                </svg>
              </div>
              <p className="text-black text-sm sm:text-base"><span className="font-semibold">Lifestyle Shoots</span> (hospitality, wellness, education, fashion)</p>
            </div>
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <p className="text-black text-sm sm:text-base"><span className="font-semibold">Product shoots</span> (fmcg, d2c, skincare, food & beverage)</p>
            </div>
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <p className="text-black text-sm sm:text-base"><span className="font-semibold">Service-based brand shoots</span> (clinics, salons, consulting, fitness)</p>
            </div>
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <p className="text-black text-sm sm:text-base"><span className="font-semibold">Founders/team photoshoots</span> for brand storytelling</p>
            </div>
          </div>
          ...
          <div className="space-y-3 sm:space-y-4">
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <p className="text-black text-sm sm:text-base"><span className="font-semibold">BTS And Workspace Shoots</span></p>
            </div>
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <p className="text-black text-sm sm:text-base"><span className="font-semibold">Reels and video</span> content captured during shoots</p>
            </div>
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <p className="text-black text-sm sm:text-base"><span className="font-semibold">Styled content</span> for instagram grids, stories, and ads</p>
            </div>
          </div>
        </div>
        ...
        <div className="mb-8 sm:mb-12">
          ...
          <div className="flex justify-center mb-6 sm:mb-8">
            <div className="flex bg-gray-100 rounded-lg p-1">
              <button
                ...
                className={`px-4 sm:px-6 py-1.5 sm:py-2 rounded-md font-medium transition-all duration-300 text-sm sm:text-base ${
                  activeTab === 'fb'
          ...
          {/* Image Grid */}
          <div className="px-4 sm:px-12 md:px-24 lg:px-48">
            ...
            <div className="flex justify-center mt-4 sm:mt-6">
              <div className="grid grid-cols-2 gap-3 sm:gap-6 w-full sm:w-1/2">
                {activeTab === 'fb' 
      ...
      <div className="w-full px-4 xxl:px-8 py-8 sm:py-12 md:py-16 bg-[#ECECEC]">
        <div className="text-center mb-8 sm:mb-12">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-3 sm:mb-4 text-black">Written Content Creation</h2>
          <p className="text-black text-sm sm:text-base">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 mb-8 sm:mb-12 px-4 sm:px-12 md:px-24 lg:px-48">
          <div className="space-y-3 sm:space-y-4">
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <p className="text-black text-sm sm:text-base"><span className="font-semibold">Instagram Captions</span></p>
            </div>
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <p className="text-black text-sm sm:text-base"><span className="font-semibold">Website Copy</span> (Home, About, Services, Landing Pages)</p>
            </div>
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <p className="text-black text-sm sm:text-base"><span className="font-semibold">Blogs</span>, articles, and newsletters</p>
            </div>
          </div>
          ...
          <div className="space-y-3 sm:space-y-4">
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <p className="text-black text-sm sm:text-base"><span className="font-semibold">Scripts</span> for videos, reels, and interviews</p>
            </div>
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <p className="text-black text-sm sm:text-base"><span className="font-semibold">Ad Copy</span> For Facebook, Google, And LinkedIn Ads</p>
            </div>
            ...
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <p className="text-black text-sm sm:text-base"><span className="font-semibold">Email</span> Sequences And Announcement Copy</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 xxl:px-8 py-8 sm:py-12 md:py-16">
        <div className="text-center mb-8 sm:mb-12">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-3 sm:mb-4 text-black">Our Process</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 md:gap-8 max-w-6xl mx-auto">
          <div className="text-center">
            <div className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 bg-[#0a5c35] rounded-full flex items-center justify-center mb-3 sm:mb-4 mx-auto">
              <span className="text-white font-bold text-lg sm:text-xl">1</span>
            </div>
            <h3 className="text-sm sm:text-base md:text-xl font-bold mb-2 sm:mb-3 text-black">Discovery & Planning</h3>
          ...
          <div className="text-center">
            ...
            <h3 className="text-sm sm:text-base md:text-xl font-bold mb-2 sm:mb-3 text-black">Pre-Production</h3>
            <p className="text-gray-700 text-xs sm:text-sm">
          ...
          <div className="text-center">
            ...
            <h3 className="text-sm sm:text-base md:text-xl font-bold mb-2 sm:mb-3 text-black">Shoot Day</h3>
            <p className="text-gray-700 text-xs sm:text-sm">
          ...
          <div className="text-center">
            ...
            <h3 className="text-sm sm:text-base md:text-xl font-bold mb-2 sm:mb-3 text-black">Post-Production</h3>
            <p className="text-gray-700 text-xs sm:text-sm">
      ...
      <div className="w-full px-4 xxl:px-8 py-8 sm:py-12 md:py-16 bg-[#ECECEC]">
        <div className="container mx-auto">
          <div className="text-center mb-8 sm:mb-12">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-3 sm:mb-4 text-black">Why Choose JIVO for Content Creation & Production?</h2>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8 max-w-6xl mx-auto">
            <div className="bg-white p-4 sm:p-6 rounded-lg shadow-lg">
              ...
              <h3 className="text-sm sm:text-base md:text-lg font-bold mb-2 text-black">High Quality Visuals</h3>
              <p className="text-gray-700 text-xs sm:text-sm">
            ...
            <div className="bg-white p-4 sm:p-6 rounded-lg shadow-lg">
              ...
              <h3 className="text-sm sm:text-base md:text-lg font-bold mb-2 text-black">Strategic Planning</h3>
              <p className="text-gray-700 text-xs sm:text-sm">
            ...
            <div className="bg-white p-4 sm:p-6 rounded-lg shadow-lg">
              ...
              <h3 className="text-sm sm:text-base md:text-lg font-bold mb-2 text-black">Production You Can Trust</h3>
              <p className="text-gray-700 text-xs sm:text-sm">
            ...
            <div className="bg-white p-4 sm:p-6 rounded-lg shadow-lg">
              ...
              <h3 className="text-sm sm:text-base md:text-lg font-bold mb-2 text-black">One Point of Contact</h3>
              <p className="text-gray-700 text-xs sm:text-sm">
            ...
            <div className="bg-white p-4 sm:p-6 rounded-lg shadow-lg">
              ...
              <h3 className="text-sm sm:text-base md:text-lg font-bold mb-2 text-black">Platform-Ready Deliverables</h3>
              <p className="text-gray-700 text-xs sm:text-sm">
            ...
            <div className="bg-white p-4 sm:p-6 rounded-lg shadow-lg">
              ...
              <h3 className="text-sm sm:text-base md:text-lg font-bold mb-2 text-black">Fast Turnaround</h3>
              <p className="text-gray-700 text-xs sm:text-sm">
      ...
      <div className="flex justify-center items-center w-full">
        <ResultComponent serviceType="content-creation" />
      </div>
      ...
      {/* FAQ Section */}
      <section className="py-8 sm:py-12 bg-gradient-to-b from-[#0a5c35]/5 to-white relative">
